...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="views/loja/index.jsp">Loja Virtual</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown active"><a href="#"
						...
						<ul class="dropdown-menu">
							<li class="active"><a
								href="views/produtos/cadastro_produto.jsp">Cadastrar produto</a></li>
							<li><a href="views/produtos/consulta_produto.jsp">Excluir
					...
					<li class="dropdown active"><a href="#"
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="../compras/carrinho.jsp">Carrinho
									de compras</a></li>
							<li><a href="views/clientes/historico_do_pedido.jsp">Historico
									de pedidos</a></li>
						</ul></li>
					<li class="dropdown active"><a href="#"
						...
						<ul class="dropdown-menu">
							<li class="active"><a
								href="views/clientes/cadastro_cliente.jsp">Cadastrar cliente</a>
							</li>
							<li><a href="views/clientes/historico_do_pedido.jsp">Consultar
									cliente</a></li>
						</ul></li>
					<li class="dropdown active"><a href="#"
						...
						<ul class="dropdown-menu">
							<li class="active"><a
								href="views/relatorios/consulta_cliente_relatorio.jsp">Pedidos
									por cliente</a></li>
							<li><a href="views/relatorios/relatorio_pedidos_data.jsp">Pedidos
									por data</a></li>
						</ul></li>
					<li class="dropdown active"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown">Usuario <b
							class="caret"></b></a>
						<ul class="dropdown-menu">
							<li class="active"><a href="views/clientes/alteracao.jsp">Alterar
									conta_</a></li>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Produtos a vend:</h1>
				<!-- <ol class="breadcrumb">
		...
		<form action="../../InserirProdutoNoCarrinho">
			<div class="row">
				...
				<div class="col-md-5">
					...
					<h2>Sandy e Junio uma aventura virtual_</h2>
