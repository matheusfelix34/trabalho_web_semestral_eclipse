...
<body>
    ...
    <h1>Exclusão Realizada com sucecesso!</h1>
    <p class="text-center"><a href="consulta_produto.jsp">Voltar ao páina de consulta</a></p>
    <br>
    <p class="text-center"><a href="../loja/index.jsp">Voltar ao páina principal</a></p>
